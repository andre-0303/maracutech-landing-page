...
import { Rocket, ArrowUpRight, TrendingUp, Play } from "lucide-react";
      ...
      <main className="flex-1 flex items-center px-10 py-20 lg:px-20">
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute -right-8 bottom-20 z-20 bg-yellow-500 p-6 rounded-2xl shadow-2xl flex items-center gap-4 border border-white/50 -rotate-3 hover:  transition-transform duration-300">
              <div className="w-14 h-14 bg-black/10 rounded-xl flex items-center justify-center">
                <TrendingUp size={30} className="text-[#1A1A1A]" />
              </div>
